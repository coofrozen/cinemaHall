...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url("Admin/home")?>"><i class="fas fa-tachometer-alt"></i> Home</a></li>
        ...
        <div class="row">
                    <div class="col-lg-6">
                           <div class="box box-success">
                                 ...
                                 <div class="box-body">
                                    <br>
                                             <?php echo form_open_multipart('Admin/push/'.$push_controller);?>
                  ...
                  <a class="btn btn-success form-control" href="<?php echo base_url('Admin/push')?>">VIEW SUMMARY<span class="fa fa-bar-chart-o pull-right"></span></a>
                </div>
              </div>
    ...
    function truncate()
    {
      if(confirm('Are you sure delete all the data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('Admin/push/truncate')?>",
            type: "POST",
            dataType: "JSON",
